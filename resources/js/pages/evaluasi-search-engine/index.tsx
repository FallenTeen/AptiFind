...
import { Search, Plus, Building2, Star, Calendar } from 'lucide-react';
...
export default function EvaluasiSearchEngineIndex({ evaluasi }: Props) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Evaluasi Search Engine" />
            <PageLayout>
                <PageHeader 
                    title="Evaluasi Search Engine"
                        ...
                        <CardContent>
                            ...
                            {evaluasi.data.length === 0 && (
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-gray-500 mb-4">Anda belum melakukan evaluasi search engine</p>
                                    <Link
                                        href="/evaluasi-search-engine/create"
                                        className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
                                    >
