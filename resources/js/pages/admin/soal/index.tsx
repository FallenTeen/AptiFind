      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-indigo-100 mt-2">
                  Kelola soal untuk sistem penilaian minat dan bakat ({soal.length} soal)
                </p>
              </div>
              <Link
        ...
        <div className="space-y-4">
          {filteredSoal.length === 0 ? (
            ...
            filteredSoal.map((s) => (
              <div key={s.id} className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-200">
                <div className="p-6">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center px-4 py-2 text-emerald-600 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors duration-200 text-sm font-medium"
                      >
                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
