...
type CreatePerguruanTinggiForm = {
    nama: string;
    akronim: string;
    jenis: string;
    alamat: string;
...
export default function CreatePerguruanTinggi() {
    const { data, setData, post, processing, errors } = useForm<CreatePerguruanTinggiForm>({
        nama: '',
        akronim: '',
        jenis: 'universitas',
        alamat: '',
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('admin.perguruan-tinggi.store'));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Perguruan Tinggi - Admin" />
            <PageLayout>
                <PageHeader
                    title="Tambah Perguruan Tinggi Baru"
                    subtitle="Masukkan informasi perguruan tinggi yang akan ditambahkan"
                />
